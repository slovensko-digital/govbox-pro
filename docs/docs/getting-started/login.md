---
title: "Prihlásenie do GovBox PRO"
description: "Návod na prihlásenie do GovBox PRO - možnosti autentifikácie a výhody oproti štátnej schránke."
keywords: ["prihlásenie", "govbox", "slovensko.sk", "autentifikácia"]
---
...
Prihlásiť sa do GovBox PRO je možné:
...
- **[Kontaktovať podporu](mailto:podpora@slovensko.digital)**
