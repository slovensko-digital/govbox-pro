...
![Schránky v nastaveniach](../../assets/images/getting-started/admin-mailboxes-menu.png)

### Formulár pripojenia schránky
![Formulár pripojenia schránky](../../assets/images/getting-started/mailbox-connect-form.png)
