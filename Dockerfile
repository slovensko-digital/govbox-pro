...
# Install Node.js 22 rather than the Debian default (Node.js 18).
...
# Install packages
RUN apt-get update && apt-get install -y build-essential nodejs libpq-dev fop=1:2.* libsaxon-java libsaxonb-java chromium \
