class NewMessageDraftComponent < ViewComponent::Base
  ...
  def initialize(message:, templates_list:, boxes:, recipients_list: nil, selected_box_params: nil, selected_message_template: nil)
    @message = message
    @templates_list = templates_list
    @boxes = boxes
    @recipients_list = recipients_list
    @selected_box_params = selected_box_params
