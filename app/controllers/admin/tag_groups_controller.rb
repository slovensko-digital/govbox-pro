class Admin::TagGroupsController < ApplicationController
  ...
  def create
    ...
    @tag_group.save!
    redirect_to edit_permissions_admin_tenant_group_url(Current.tenant, @tag_group.group), notice: "Tag permission bol úspešne priradený"
  end

  def destroy
    authorize([:admin, @tag_group])
    @tag_group.destroy
    redirect_to edit_permissions_admin_tenant_group_url(Current.tenant, @tag_group.group), notice: "Tag permission bol úspešne odstránený"
  end
