class Settings::AutomationRulesController < ApplicationController
  ...
  def create
    ...
    if @automation_rule.save
      redirect_to settings_automation_rules_path, notice: 'Automatizačné pravidlo bolo úspešne vytvorené'
    else
  ...
  def update
    ...
    if @automation_rule.update(automation_rule_params)
      redirect_to settings_automation_rules_path, notice: 'Automatizačné pravidlo bolo úspešne upravené'
    else
  ...
  def destroy
    ...
    redirect_to settings_automation_rules_path, notice: 'Automatizačné pravidlo bolo úspešne odstránené'
  end
