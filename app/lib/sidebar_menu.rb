class SidebarMenu
  ...
  def admin_menu
    ...
    [
      ...
      TW::SidebarMenuItemComponent.new(name: 'Aktivácia rozšírení', url: admin_tenant_feature_flags_path(Current.tenant), icon: Common::IconComponent.new("puzzle-piece"))
    ]
  end
